...
class AdvisorTest {
    ...
    static class MyMethodMatcher implements MethodMatcher {
        ...
        public boolean matches(Method method, Class<?> targetClass) {
            boolean matchName = method.getName().equals("save");
            log.info("포인트컷 호출 = {} targetClass = {}", method.getName(), targetClass);
            log.info("포인트컷 결과 result = {}", matchName);
            return matchName;
        }
